...
## 1. Legal Ownership Structure  
   ...
   * In conclusion: Members need the ability to sell their land at a fair price if they wish to leave the project. However, remaining members need to be assured that only an approved buyer can join. Both of these concerns can be address in the LLC operating agreement. 
   ### 1.4 Risks    
