...
## 1. Legal Ownership Structure  
   ...
   * The primary land-owning LLC must include share transfer restrictions and buy-out options that balance the interests of exiting parties and existing members  
   ### 1.4 Risks    
   * 1.4.1 Inheritance - a co-owner may pass away and his share of the LLC be passed on to an unknown family member. We could include a clause prohibiting entry of un-authorized heirs to the corporation's property, thus encouraging the to sell or rent if they do not receive approval to access. 
